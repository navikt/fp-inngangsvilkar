...
import static no.nav.foreldrepenger.inngangsvilkaar.regelmodell.medlemskap.v2.Personopplysninger.RegionPeriode;
...
class MedlemskapsvilkårTest {
    ...
    @Test
    void finner_avvik() {
        var vurderingsperiodeBosatt = new LocalDateInterval(of(2024, Month.JANUARY, 1), of(2024, Month.JANUARY, 1));
        var vurderingsperiodeLovligOpphold = new LocalDateInterval(of(2024, Month.JANUARY, 1), of(2024, Month.JANUARY, 2));
        var registrertMedlemskapPerioder = Set.of(new LocalDateInterval(of(2024, Month.JANUARY, 1), of(2024, Month.JANUARY, 1)));
        ...
        var søknad = new MedlemskapsvilkårGrunnlag.Søknad(Set.of(new LocalDateInterval(of(2024, Month.JANUARY, 1), of(2024, Month.JANUARY, 1))));
        var arbeid = new MedlemskapsvilkårGrunnlag.Arbeid(Set.of(), Set.of());
        var skjæringstidspunkt = of(2024, Month.JANUARY, 1);
        var behandlingsdato = of(2024, Month.JANUARY, 1);
    ...
    void ingen_avvik_hvis_alt_ok() {
        var vurderingsperiodeBosatt = new LocalDateInterval(of(2024, Month.JANUARY, 1), of(2024, Month.JANUARY, 1));
        var vurderingsperiodeLovligOpphold = new LocalDateInterval(of(2024, Month.JANUARY, 1), of(2024, Month.JANUARY, 3));
        var norden = new RegionPeriode(new LocalDateInterval(of(2024, Month.JANUARY, 1), of(2024, Month.JANUARY, 1)), Region.NORDEN);
        var tredjeland = new RegionPeriode(new LocalDateInterval(of(2024, Month.JANUARY, 2), of(2024, Month.JANUARY, 2)), Region.TREDJELAND);
        var eøs = new RegionPeriode(new LocalDateInterval(of(2024, Month.JANUARY, 3), of(2024, Month.JANUARY, 3)), Region.EØS);
        ...
        var arbeid = new MedlemskapsvilkårGrunnlag.Arbeid(Set.of(vurderingsperiodeLovligOpphold),
            Set.of(new MedlemskapsvilkårGrunnlag.Arbeid.Inntekt(new LocalDateInterval(of(2023, Month.DECEMBER, 1), of(2023, Month.DECEMBER, 31)), grunnbeløp)));
        var behandlingsdato = of(2024, Month.JANUARY, 1);
